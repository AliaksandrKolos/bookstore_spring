...
VALUES ('Bob', 'Kolos', 'admin', 'D033E22AE348AEB5660FC2140AEC35850C4DA997', (SELECT id FROM roles WHERE role_name = 'ADMIN')),
       ('Sam', 'Smith', 'manager', '1A8565A9DC72048BA03B4156BE3E569F22771F23', (SELECT id FROM roles WHERE role_name = 'MANAGER')),
       ('Michael', 'Johnson', 'user', '12DEA96FEC20593566AB75692C9949596833ADC9', (SELECT id FROM roles WHERE role_name = 'USER')),
